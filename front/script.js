class App extends React.Component {
  ...
  getWord() {
    ...
    xmlhttp.addEventListener('load', function (datos) {
      ...
      console.log(aux)
      //aux1 = aux.split(":")
      console.log(aux.charAt(11))
      console.log(aux.charAt(12))
      console.log(aux.charAt(13))
      console.log(aux.charAt(14))
      // paraula.concat(aux.charAt(11))
      //paraula.concat(aux.charAt(12))
      // paraula [,aux.charAt(12),aux.charAt(13),aux.charAt(14)]
      //console.log(paraula)
   ...
   console.log("entro en funció getWord")
    fetch('http://127.0.0.1/sad/new_word.php')
      .then((response) => {
